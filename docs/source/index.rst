...
This backend is primarily aimed at solving hypergraph algorithms using probabilistic inferences and Bayesian decision making while also allowing the native expression of probabilistic programming models as hypergraphs ie structural causal models (SCM) and gaussian mixture models (GMM). 
